...
(
    ...
    (SELECT id FROM "CREDIT_PACKAGE" WHERE name = '14 堂組合包'), 
    (SELECT credit_amount FROM "CREDIT_PACKAGE" WHERE name = '14 堂組合包'),
 	(SELECT price FROM "CREDIT_PACKAGE" WHERE name = '14 堂組合包')
),
(
    (SELECT id FROM "USER" WHERE name = '王小明'),
    (SELECT id FROM "CREDIT_PACKAGE" WHERE name = '21 堂組合包'), 
    (SELECT credit_amount FROM "CREDIT_PACKAGE" WHERE name = '21 堂組合包'),
 	(SELECT price FROM "CREDIT_PACKAGE" WHERE name = '21 堂組合包')
),
(
